...
class Operacion:
    ...
    @abstractmethod
    def operaciones(self, parametro1, parametro2):
        return
...
class Primo(Operacion):
    ...
    def operaciones(self, numero, numero2=0):
        primo = True
        if numero is 2:
            primo = True
        elif numero % 2 is 0:
...
class Pitagoras_hipotenusa (Operacion):
    ...
    def operaciones(self, parametro1, parametro2):
        ...
        cateto1_potencia = clase_calculo_de_potencias.operaciones(numero1, 2)
        cateto2_potencia = clase_calculo_de_potencias.operaciones(numero2, 2)
...
class piatgoras_cateto(Operacion):
    ...
    def operaciones(self, numero1, numero2):
        clase_calculo_de_potencias = Potencias()
        cateto1_potencia = clase_calculo_de_potencias.operaciones(numero1, 2)
        hipotenusa_potencia = clase_calculo_de_potencias.operaciones(numero2, 2)
...
class funcion_externa(Operacion):
    __nombre = ''
    __codigo = ''
